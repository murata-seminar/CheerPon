...
//  
//
//  Created by kmurata on 2019/11/17.
 ...
 */
    ...
    //時間帯を調べる
    //現在時刻が05:00から10:59であれば true, それ以外であればfalseを返す
    ...
    //現在時刻が11:00から12:59であれば true, それ以外であればfalseを返す
    func NoonTime() -> Bool {
        let now = Date()
        let calendar = Calendar.current
        let hour:Int = calendar.component(.hour, from: now)
    ...
    //現在時刻が13:00から17:59であれば true, それ以外であればfalseを返す
    ...
    //現在時刻が18:00から22:59であれば true, それ以外であればfalseを返す
    func NightTime() -> Bool {
        let now = Date()
        let calendar = Calendar.current
        let hour:Int = calendar.component(.hour, from: now)
    ...
    //現在時刻が23:00から04:59であれば true, それ以外であればfalseを返す
    func MidNightTime() -> Bool {
        let now = Date()
        let calendar = Calendar.current
        let hour:Int = calendar.component(.hour, from: now)
