...
class myNotificationMessages{
    //ちあぽんのセリフあおりバージョン
    var cheerpon_Morning_aori: [String] = ["エラく早起きだな！仕方ないから早起きしてやったわ！！","まだ眠いだろwコッチにも起こしに来い!","本当に起きてるのか？無理だろw","まだ１日スタートしたところだなw","どれだけスマホ使ってるか教えてやってもいいぞw"]
    var cheerpon_AfterNoon_aori: [String] = ["メシ食ってる時もスマホ離せない奴発見","スマホ触ってないでたまには他人と話せば？","早くやることやんねーと今日中に終わらんな♪","やっと午後が始まったな！そんな調子で電池もつの？","お前がスマホ見てる間にメシ食っとくわ"]
    var cheerpon_Night_aori: [String] = ["腹へったな！スマホ触りすぎて夕飯食う暇もないんじゃねーのw","今日ももうすぐ終わるというのにスマホをやめられない奴w","スマホやってないで誰かと話せばいいのに・・あ、そんな友達いないとか？","明日はもっと休憩した方がいいんじゃねーの？","スマホ使用量、もっと増やすか？"]
